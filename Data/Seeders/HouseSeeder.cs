        ...
        public static List<House> GetHouses()
        {
            return new List<House>
            {
                new House
                {
                    ...
                    RelatedEntityIds = new List<string> { "loc_Caladan", "loc_Arrakis", "char_DukeLetoAtreides", "char_PaulAtreides", "char_LadyJessica" },
                    Sigil = "A red hawk",
                ...
                new House
                {
                    ...
                    RelatedEntityIds = new List<string> { "loc_GiediPrime", "char_BaronHarkonnen", "char_FeydRautha", "char_GlossuRabban" },
                    Sigil = "A griffin",
                ...
                new House
                {
                    ...
                    RelatedEntityIds = new List<string> { "loc_Kaitain", "loc_SalusaSecundus", "char_ShaddamIV", "char_PrincessIrulan", "org_Sardaukar" },
                ...
                new House
                {
                    ...
                    RelatedEntityIds = new List<string> { "loc_Ix", "theo_ButlerianDoctrine" },
                ...
                new House
                {
                    ...
                    RelatedEntityIds = new List<string> { "loc_Ix", "house_Richese" },
                    Sigil = "Not widely recorded",
                    Motto = "Not widely recorded",
                ...
                new House
                {
                    ...
                    RelatedEntityIds = new List<string> { "house_Corrino", "char_ShaddamIV", "org_BeneGesserit" },
                    Sigil = "Not widely recorded",
                    Motto = "Not widely recorded",
