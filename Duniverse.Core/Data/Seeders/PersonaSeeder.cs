            ...
            return new List<Persona>
            {
                ...
                */
                ...
                new Persona
                {
                    ...
                    ShortDescription = "The gentle, ineffectual half-brother of Baron Vladimir Harkonnen, exiled for his perceived weakness.",
                    DetailedHistory = "House Harkonnen judged Abulurd too gentle to rule, too soft-hearted by the family's own brutal standard, and stripped him of leadership outright. They exiled him to Lankiveil, a modest whale-fur world, and the humiliation echoed through the family for generations. Abulurd's kindness was genuine, his refusal to rule by cruelty a real conviction, not a failing, and that made his exile an ideological rejection as much as a political one. His half-brother Vladimir grew up under the weight of that family shame and spent his whole life overcorrecting for it, building a reputation on calculated cruelty Abulurd never would have chosen. The quiet, humble life Abulurd made for himself on Lankiveil stood, ever after, as proof of the path House Harkonnen refused to walk.",
