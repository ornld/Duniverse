        ...
        public static List<FloraFauna> GetFloraFaunas()
        {
            return new List<FloraFauna>
            {
                ...
                new FloraFauna
                {
                    ...
                    DetailedHistory = "Tleilaxu genetic science built the futar at the Honored Matres' request. It combines heightened feline senses and physical power with trained cunning, sharp enough to make it a uniquely effective hunter of otherwise elusive prey. Its creators had a specific target list in mind: Bene Gesserit adepts and Duncan Idaho gholas. Both were trained well enough to slip past ordinary human pursuers without much trouble. A futar hunts on a chilling mix of raw instinct and calculated purpose, savage in ways you can predict and tactical in ways you cannot. That combination made it feared even among factions well used to genetically engineered threats. Its existence says a great deal about how far the Honored Matres and their Tleilaxu collaborators would go to crush what remained of the Old Imperium's resistance.",
