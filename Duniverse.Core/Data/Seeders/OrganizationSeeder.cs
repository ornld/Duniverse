        ...
        public static List<Organization> GetOrganizations()
        {
            return new List<Organization>
            {
                ...
                new Organization
                {
                    ...
                    HistoryLayers = new List<HistorySegment>
                    {
                        new(SpoilerTier.Chapterhouse, "Out of that wreckage came an uneasy merging of the two orders, carried in one woman: Murbella, once an Honored Matre, later a Bene Gesserit Reverend Mother, finally the head of both. The conquest ended in neither victory nor defeat but in absorption, and what the Matres carried back from the Scattering survives inside the Sisterhood that swallowed them."),
                    },
