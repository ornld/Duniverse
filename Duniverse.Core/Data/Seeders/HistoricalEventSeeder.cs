        ...
        public static List<HistoricalEvent> GetHistoricalEvents()
        {
            return new List<HistoricalEvent>
            {
                ...
                new HistoricalEvent
                {
                    ...
                    DetailedHistory = "Paul's prescience made him unpredictable, and his Fremen legions made him untouchable by ordinary force. That left the Bene Gesserit, the Spacing Guild, and the Bene Tleilax no good options. They set their old rivalries aside and came at him together. Reverend Mother Gaius Helen Mohiam and the bloated Guild Steersman Edric handled the political cover. The Tleilaxu Face Dancer Scytale brought the real weapon. It was a ghola of Paul's dead swordmaster Duncan Idaho, grown from cellular stock and renamed Hayt. The ghola was built to break Paul from the inside by dragging old loyalties and old grief back to the surface. The final blow landed through a stolen Guild weapon, and it burned out his eyes. He stood blind in a universe where prescience alone let him still see anything at all. Blindness did not break him the way the conspirators wanted. Losing Chani did, and she died bearing his twins soon after, which was the one loss his enemies never had to arrange. He walked out into the desert to die by Fremen custom. He vanished from the Imperium entirely and left his sister Alia to rule in his place as Regent.",
