        ...
        public static List<TheologicalSystem> GetTheologicalSystems()
        {
            return new List<TheologicalSystem>
            {
                ...
                new TheologicalSystem
                {
                    ...
                    DetailedHistory = "Leto II looked ahead and saw a species heading toward its own end. Stagnation under any centralized, predictable rule would eventually invite the return of thinking machines, or prescient tyranny, or some other disaster nobody could yet name. He chose an extraordinary and irreversible answer. He merged his body with thousands of sandtrout and became the God Emperor. For thirty-five hundred years he ruled under a doctrine of enforced peace and deliberate stagnation. It was a slow pressure, meant to make humanity's eventual scattering across the galaxy inevitable and impossible for any single power to control again. The cost was almost unthinkable. Leto gave up his own humanity and imposed centuries of suffocating rule on an Imperium that never fully forgave him, and could not, really, have been expected to. His stolen journals surfaced long after his death. They laid bare a plan so far outside ordinary political or religious thought that even the people closest to him during his reign had grasped only pieces of it.",
