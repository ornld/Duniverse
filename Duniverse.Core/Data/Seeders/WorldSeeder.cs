        ...
        public static List<World> GetWorlds()
        {
            return new List<World>
            {
                new World
                {
                    ...
                    DetailedHistory = "Arrakis orbits the star Canopus, third planet out, and offers almost nothing in the way of open water. What it has instead are dune seas without visible end and sandworms of terrifying size, creatures whose life cycle happens to manufacture the geriatric spice found on no other world in the universe. That aridity pushed the native Fremen toward a culture built entirely around hoarding moisture: stillsuits reclaim sweat and breath, sietch cisterns collect water drop by drop across generations, all of it aimed at a dream of turning the planet green. Melange underwrites Guild navigation, extends human life, and threads through commerce across the Imperium, so whoever held Arrakis as a fief inherited both staggering wealth and a target on their back. That combination pulled House Atreides, House Harkonnen, and eventually Paul Atreides into a fight over the planet that rewrote galactic history. Paul's Fremen legions took it by force in the end, and Arrakis stopped being a fief some Emperor could hand out or revoke; it became the throne from which the Atreides Imperium, and later Leto II's Golden Path, governed everything.",
                ...
                new World
                {
                    ...
                    DetailedHistory = "Seas, mountains, and fertile lowlands given over to fishing fleets and pundi rice paddies: this was Caladan, ancestral seat of House Atreides across twenty-six generations. Its mild climate bred a Ducal court that prized cultured restraint over brute military display. Duke Leto Atreides governed with the kind of easy, personal affection that comes from actually knowing one's subjects by name, and that same warmth made House Atreides beloved at home and dangerously conspicuous to an Emperor who trusted no one. Accepting the Arrakis fief meant Leto likely traded Caladan's safety away for good; he took the deal anyway, and the sacrifice set the destruction of his House in motion, along with his son's eventual rise. The Atreides would come to rule an Imperium vastly larger than one ocean world, yet Caladan stayed the emotional core of who they were for the length of the saga.",
                ...
                new World
                {
                    ...
                    DetailedHistory = "Centuries of unrestrained industry left Giedi Prime's skies permanently grey, its factories running without pause for so long that the pollution became the planet's defining feature: bleak, merciless, and every bit as unforgiving as the House that rules it. The largest city holds the Baron's keep, opulent on the surface and rotting underneath, where riches pulled from Arrakis and elsewhere fund private indulgence instead of any real care for a population kept in line through fear. Ordinary subjects live inside a rigid hierarchy, and defiance, even minor defiance, tends to draw brutal punishment; Caladan's more paternal style of rule has no equivalent here. Giedi Prime's grim character mirrored House Harkonnen's own reputation so precisely that the planet's name outlived the family's fall, becoming Imperial shorthand for cruelty wearing the mask of civilization.",
                ...
                new World
                {
                    ...
                    DetailedHistory = "Ten thousand years of Padishah Emperors sat on Kaitain, and the planet shows every century of it: the single most lavish world in the Imperium, its gardens manicured to the last leaf and its palaces built tall enough to overwhelm any visitor with Corrino wealth on purpose. The climate itself had been terraformed and tended purely for Imperial comfort, a monument arguing, without a word spoken, that the Corrinos alone deserved the Golden Lion Throne. Landsraad diplomacy and Imperial court ceremony played out here in their most intricate form, court games so precise that one wrong gesture could end a House as thoroughly as a lost battle. Shaddam IV's gamble on Arrakis cost House Corrino the throne in the end, and Kaitain's long run as the undisputed heart of Imperial power ended with it.",
                ...
                new World
                {
                    ...
                    DetailedHistory = "Salusa Secundus was the original Imperial capital before some still-debated cataclysm tore its surface apart; the Corrino throne later turned the wreckage into a secret training ground, its radiation-scarred terrain and forced-labor prison population feeding the machine that produces the galaxy's most feared soldiers. Brutality here was policy, not accident: the reasoning held that only conditions crueler than any real battlefield could produce warriors able to overwhelm ordinary Imperial or House troops. Generation after generation of Sardaukar recruits survived that ordeal before ritual induction into the legions, and what emerged was a fanatical loyalty to the Emperor who had chosen, quite deliberately, to torment them into greatness. The planet's real purpose stayed one of the Corrino throne's most tightly held secrets for thousands of years, load-bearing for the myth of Sardaukar invincibility that finally broke apart on Arrakis.",
                ...
                new World
                {
                    ...
                    DetailedHistory = "Ix hides its cities in artificial caverns carved deep beneath a cold and forbidding surface, and out of that hidden industry came real wealth and influence: the massive Heighliners that carry the Spacing Guild's cargo, plus a whole catalog of devices that creep uncomfortably close to the Butlerian Jihad's ban on thinking machines. Ixian engineers kept up a careful public fiction, insisting nothing built underground counted as a true thinking machine, and the line between permitted computation and forbidden artificial intelligence got thinner with every new invention. That balancing act made Ix indispensable across the Imperium; Houses and organizations everywhere leaned on Ixian technology, all of them publicly upholding the very taboo Ix quietly tested. House Vernius grew too independent for the Imperial throne's comfort eventually, and a Tleilaxu-engineered coup, sanctioned in secret from above, swapped out the planet's rulers without ever slowing the flow of Ixian technology the rest of the galaxy had come to need.",
                ...
                new World
                {
                    ...
                    DetailedHistory = "Strict religious and political decree keeps outsiders off Tleilax, leaving the planet one of the least understood worlds in the Imperium, its geography and true capabilities guarded as jealously as the axlotl tanks where its people culture gholas, Face Dancers, and other bio-engineered products. The Tleilaxu hold to a religious philosophy few outsiders ever glimpse, let alone comprehend, and that professed piety functions as sincere belief and convenient cover in equal measure, serving whatever scheme the planet's long game requires. Visitors rare enough to set foot on Tleilax meet a culture that plays itself as harmless, even humble, a performance calculated closely enough that generations of Tleilaxu leaders have used it to run circles around powerful factions who underestimate them. Millennia of this secrecy have let Tleilax punch well above its formal political weight, trading in biological services no other world in the Imperium can match.",
                ...
                new World
                {
                    ...
                    DetailedHistory = "Wallach IX was picked precisely for how little attention it draws: a quiet, unassuming planet that hides the true seat of Bene Gesserit power behind a facade of pastoral insignificance, its Mother School shielded from scrutiny a more conspicuous headquarters would invite. Acolytes inside its cloistered halls undergo the Sisterhood's punishing mental and physical conditioning, training built to strip away weakness, fear, and involuntary reaction until nothing remains but disciplined, purposeful control. The isolation serves a second, more practical purpose too: it keeps the Bene Gesserit's centuries-spanning breeding program hidden, a project so sprawling that most Sisters know only their own small piece of it. Outsiders rarely grasp how much this modest, overlooked world actually shapes bloodlines and belief across the entire Imperium.",
                ...
                new World
                {
                    ...
                    DetailedHistory = "Ecaz's master woodcarvers are famous across the Imperium, their finished work fetching prices among the highest of any luxury good the Landsraad trades in, and the planet's dense forests supply hardwoods rare enough to exist nowhere else in known space. That cultured, peaceable reputation sits right beside a much bloodier one: House Ecaz's generations-old feud with House Moritani of Grumman, a conflict worked out through formal duels of honor about as often as it was through open warfare. The feud eventually reached into House Atreides affairs during the years of Paul's children, pulling Ecaz's fortunes into currents far beyond its own borders. Grumman's threat never really went away; Ecaz endured regardless, one of the Landsraad's more diplomatically respected worlds, its artistry a genuine point of pride under constant danger.",
                ...
                new World
                {
                    ...
                    DetailedHistory = "Harkonnen governors built Arrakeen first, setting it against the natural windbreak of the Shield Wall so its architecture could shelter the ruling House from the planet's ferocious Coriolis storms. Duke Leto inherited a capital soaked in Harkonnen extraction and neglect when House Atreides took the fief, and he moved fast, if only for a short time, to govern it with a steadier, more humane hand before the Harkonnen-Sardaukar assault took it back. The city changed hands once more when Paul Atreides' Fremen legions broke through the Shield Wall and stormed in, and from Arrakeen's palace Paul went on to rule not just Arrakis but the entire Known Universe as Emperor. Its later years fused Fremen custom with the trappings of Imperial court life, a physical record of how completely desert culture and galactic power had merged under Muad'Dib.",
                ...
                new World
                {
                    ...
                    DetailedHistory = "Onn is not Arrakeen. Where Arrakeen governs, Onn performs: vast plazas and processional avenues built to hold crowds gathered for the pageantry of Muad'Dib's empire, at a scale no ordinary city could hold. Paul Atreides staged his massed convocations and state ceremonies here, occasions meant to cement religious authority alongside political rule, Imperial tradition folded together with the fervent devotion of the Church of Muad'Dib. The city's design itself gave shape to the uneasy marriage at the center of Paul's reign, a government that needed both the machinery of Imperial administration and the theater of religious spectacle to hold an empire won by holy war together. Onn's grand ceremonies kept running under Paul's successors, a stage built for a religion that had long since outgrown the man who started it.",
                ...
                new World
                {
                    ...
                    DetailedHistory = "Carved deep into the rock of the Shield Wall and hidden from any casual eye, Sietch Tabr ranked among the largest and most influential Fremen communities on Arrakis, its concealed cavern reservoirs holding water reclaimed one drop at a time across generations. Naib Stilgar led it: pragmatic, fiercely loyal, and the man whose sietch sheltered Paul and Jessica Atreides after their escape into the desert, giving Paul the protection and training that turned a hunted noble's son into the Fremen war leader Muad'Dib. Strict water discipline and communal governance under a Naib-led council defined the place, the same values that had carried the Fremen through Arrakis's harshest terrain for generations before any outsider set foot there. Sietch Tabr's fortunes climbed with Paul's own, and the sietch became a symbolic stronghold of Fremen resistance, then later of the loyalty that carried Paul's jihad out across the stars.",
                ...
                new World
                {
                    ...
                    DetailedHistory = "Leto II died at the Hidden Ford, and billions of dormant sandtrout flooded back into the wild; the elaborate ecological engineering that had held Arrakis's deserts in check for thirty-five hundred years started coming apart soon after, sand and worms and eventually spice returning to the world now renamed Rakis. Nothing about the change happened cleanly or fast. The Bene Gesserit took up quiet oversight of the reborn desert ecology, managing along the way a renewed worm-worship that grew up around Sheeana, a young woman able to command the returned sandworms outright. Rakis's rebirth as a desert world brought back the old balance of scarcity and struggle that had produced the Fremen generations earlier, though the people living there now answered to very different political masters than their ancestors ever had. Its central place in galactic history closed for good when the Honored Matres destroyed the planet outright, cutting the last confirmed natural link between spice and its Arrakeen origins.",
                ...
                new World
                {
                    ...
                    DetailedHistory = "House Harkonnen fell from power, and long afterward its grim industrial homeworld got a new name, Gammu, and a new owner: the Bene Gesserit, who turned it quietly into a training ground and archival vault. Its polluted skies and severe architecture suited the discipline the Sisterhood wanted to instill in trainees rather better than anyone might have guessed. Vast troves of historical records sat safeguarded here, some predating the Scattering itself, handing the Bene Gesserit a store of knowledge few other factions in the Imperium could rival. A symbol of Harkonnen cruelty turned into an instrument of Bene Gesserit strategy, and the shift said plenty about how willingly the Sisterhood repurposed the wreckage fallen Houses left behind for its own long game. Gammu's harsh legacy stayed etched into the landscape long after its new purpose had turned entirely away from the excesses that once defined it.",
                ...
                new World
                {
                    ...
                    DetailedHistory = "Cold water covers most of Lankiveil, and its modest whale-fur trade stands nothing like the industrial excess later built on Giedi Prime. This was the ancestral holding Abulurd Harkonnen got exiled to, judged unfit to lead House Harkonnen by the rest of the family. Life there revolved around harvesting the local whale-fur trade rather than the ruthless extraction and cruelty that would come to define the Harkonnen name elsewhere, and Abulurd's branch of the family settled into an unusually humble, unpretentious way of living. History turned that into a lasting irony: Abulurd's son, Vladimir, grew up to embody everything Lankiveil's quiet culture was not, choosing Giedi Prime instead as the seat for his infamous rule. The planet stayed a minor holding the whole time, worth more for what it reveals about the contradictions in the Harkonnen bloodline than for any wealth or strategic value of its own.",
                ...
                new World
                {
                    ...
                    DetailedHistory = "Richese spent generations as a commercial and technological rival to Ix, building its fortunes on intricate gadgets, probes, and precision mechanisms, a profitable niche too small-scale for the industrial giants of Ix to bother with and too clever for most other Houses to copy. Its inventive culture ran on constant competitive innovation, trade secrets guarded closely, and still it kept finding itself outmaneuvered, and occasionally rescued, by the shifting fortunes of House Vernius and the wider Landsraad. Richese's engineers pushed hard and often against the boundaries the Butlerian Jihad had set for permissible technology, turning out devices that skirted the line separating clever machinery from forbidden thinking machines without quite crossing it. Political power on the scale of the true military Houses never came its way, but Richese's technological ingenuity kept it a fixture of Imperial commerce for generations regardless.",
