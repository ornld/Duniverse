        ...
        public static List<World> GetWorlds()
        {
            return new List<World>
            {
                ...
                new World
                {
                    ...
                    DetailedHistory = "Ix hides its cities in artificial caverns carved deep beneath a cold, forbidding surface. Out of that hidden industry came real wealth and influence. It built the massive Heighliners that carry the Spacing Guild's cargo, along with a whole catalog of devices that creep uncomfortably close to the Butlerian Jihad's ban on thinking machines. Ixian engineers kept up a careful public fiction, insisting nothing built underground counted as a true thinking machine. The line between permitted computation and forbidden artificial intelligence got thinner with every new invention. That balancing act made Ix indispensable across the Imperium. Houses and organizations everywhere leaned on Ixian technology, all of them publicly upholding the very taboo Ix quietly tested. The arrangement suited enough powerful people that nobody ever pressed the question hard enough to spoil it.",
                    HistoryLayers = new List<HistorySegment>
                    {
                        new(SpoilerTier.ExpandedUniverse, "The prequel chronicles put a name to the family that held the planet through those years, House Vernius, and an end to their tenure. They were judged too independent for the Imperial throne's comfort, and a Tleilaxu-engineered coup, sanctioned in secret from above, swapped the planet's rulers out. The flow of Ixian technology the rest of the galaxy had come to depend on never slowed for a moment, which was the entire point of arranging it that way. Nobody with a stake in it asked many questions afterward. Those same chronicles carry the family back again. Dominic's son Rhombur spent his exile working toward exactly that, and House Vernius held Ix once more before the story closes."),
                    },
                ...
                new World
                {
                    ...
                    DetailedHistory = "Strict religious and political decree keeps outsiders off Tleilax, which leaves it one of the least understood worlds in the Imperium. Its geography, its population, and the plain facts of what it can actually do are guarded as closely as the biological work it sells. The Tleilaxu hold to a religious philosophy few outsiders ever glimpse, let alone follow, and that professed piety serves as sincere belief and convenient cover in equal measure. The rare visitor permitted to land meets a culture that presents itself as harmless and slightly shabby. The performance is deliberate, and generations of Tleilaxu leaders have used it to run rings around factions that took it at face value. Millennia of that has let a small, unremarkable-looking world punch far above its formal political weight.",
                    HistoryLayers = new List<HistorySegment>
                    {
                        new(SpoilerTier.DuneMessiah, "What the decree is actually protecting are the axlotl tanks, where the Tleilaxu culture gholas, Face Dancers, and everything else they put on the market. No rival has ever reproduced them, and no buyer has ever been shown one."),
                        new(SpoilerTier.HereticsOfDune, "The secrecy held for thousands of years and then failed all at once, and what it had been hiding was worse than commercial. The tanks were never machines. The humility was never real. And the world that had spent the whole of recorded Imperial history playing the harmless supplier had been waiting, with genuine religious patience, for its turn."),
                    },
                    ...
                    LocalCustoms = new List<string> { "Biological arts practiced as religious craft", "Strict religious secrecy toward outsiders" }
                },
                new World
                {
                    Id = "loc_WallachIX",
                ...
                new World
                {
                    ...
                    DetailedHistory = "Onn is not Arrakeen. Where Arrakeen governed, Onn performed. Leto II raised its vast plazas and processional avenues to hold the crowds his Festival drew, at a scale no ordinary city could manage. Once each decade the God Emperor left his Citadel and came here to be seen, and the Imperium came with him: Fish Speakers on parade, envoys from every world, pilgrims who had saved a lifetime to stand in the road. The occasions folded Imperial administration together with the worship of a living god, which was the uneasy marriage at the center of his reign. He needed both, and the city gave the arrangement a shape. Onn's ceremonies ran for thirty-five centuries, a stage built for a faith that had grown out of his father's and then swallowed it.",
                    RelatedEntityIds = new List<string> { "loc_Arrakis", "char_LetoIIAtreides", "org_FishSpeakers", "theo_ChurchOfMuadDib" },
                    EnvironmentalData = "A desert city engineered for mass public gatherings and processions.",
                    RulingHouse = "House Atreides",
                    LocalCustoms = new List<string> { "The Festival, held once a decade, when the God Emperor showed himself to the Imperium" }
                },
                new World
                {
                    Id = "loc_SietchTabr",
                ...
                new World
                {
                    Id = "loc_Chapterhouse",
                    Name = "Chapterhouse",
                    ShortDescription = "The Bene Gesserit's hidden homeworld, held in reserve against the day everything else was lost.",
                    DetailedHistory = "Chapterhouse stayed hidden for centuries, the Sisterhood's seat held in reserve against catastrophe, ringed by no-ships and a secrecy so complete that most of the Imperium never learned the world existed. The Honored Matre war turned the reserve into the last stronghold. Worlds the Bene Gesserit had held for millennia burned one after another, and everything that mattered fell back to the one address the enemy did not have. When Rakis died, the Sisterhood's link to the spice cycle should have died with it. It survived because of what the escape carried: out of the burning of Rakis came a single small sandworm, brought here as the seed of a gamble the Sisterhood had never dared attempt, to teach a temperate world the desert and rebuild the source of melange from nothing.",
                    HistoryLayers = new List<HistorySegment>
                    {
                        new(SpoilerTier.Chapterhouse, "The gamble ran for years and remade the world that hosted it. Deserts spread across the orchard belts on schedule, driven by patient ecological engineering, Darwi Odrade directing the effort, the sandrider Sheeana handling the worms themselves, and the once-Honored-Matre Murbella carrying it forward after them. Failure meant the effective extinction of the Sisterhood's power and of independent spice production, and everyone tending the sand knew it. Chapterhouse's fate hung between craft and existential risk, a fair measure of just how fragile the galaxy's oldest and most patient organization had grown by the end of the Scattering era."),
                    },
                    RelatedEntityIds = new List<string> { "org_BeneGesserit", "bio_ShaiHulud", "event_DestructionOfRakis", "char_DarwiOdrade", "char_Murbella", "char_Sheeana" },
                    EnvironmentalData = "A temperate world of orchards and plantations, kept off every chart the Imperium owns.",
                    RulingHouse = "Bene Gesserit",
